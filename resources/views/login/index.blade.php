...
<body>
    <div class="limiter">
            ...
            <div class="wrap-login100 p-t-50 p-b-90">
			           <form class="login100-form validate-form flex-sb flex-w" method="post" action="{{route('login.attempt')}}" autocomplete="off">
      					      <span class="login100-form-title p-b-51">Halaman Masuk</span>
                      <div class="wrap-input100 validate-input m-b-16" data-validate = "Nama Pengguna wajib diisi">
                          <input class="input100" type="text" name="username" placeholder="Nama Pengguna">
                          <span class="focus-input100"></span>
                      </div>
                      <div class="wrap-input100 validate-input m-b-16" data-validate = "Kata Sandi wajib diisi">
